...
- Target Language: {profile.language} (if Hinglish, write natural conversational Hinglish using Roman script like 'Iska matlab yeh hai ki...')
...
- Language: {plan.student_profile.language}. If 'Hinglish', talk naturally in Romanized Hinglish (mix Hindi and English seamlessly like an Indian professor: 'Dhyan se samjho, yahan critical point yeh hai...').
...
- You must produce dynamic whiteboard visuals (choose from latex formulas, mermaid diagrams, code snippets, key takeaways, analogy cards).
...
Language: {plan.student_profile.language} (Respond in the same language/Hinglish style).
